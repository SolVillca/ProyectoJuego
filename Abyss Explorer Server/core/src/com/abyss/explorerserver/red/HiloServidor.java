 ...
 // Variable para almacenar el último latido de cada cliente
   ...
   /* private void procesarMsj(DatagramPacket dp) {
    ...
    private void procesarMsj(DatagramPacket dp) {
        ...
        System.out.println(nroCliente); // devuelve -1 si clientes[] es nulo o si el puerto del cliente no coincide con el datagrampacket
            ...
            if (nroCliente != -1) {
                ...
                if(msj.startsWith("INPUT:")) {
                    ...
                    if (partes.length == 3) {
                        ...
                        //System.out.println("Movimiento recibido del cliente " + clienteId + ": " + movimiento);
                    }
    ...
    private int obtenerNroCliente(DatagramPacket dp) {
        for (int i = 0; i < clientes.length; i++) {
        	//System.out.println("obtenerNroCLiente hs: " + clientes[i]+ "  " + dp.getPort());
    ...
    private void manejarConexionCliente(DatagramPacket dp) {
        if (cantClientes < 2) {
            ...
            enviarMsj("OK:" + cantClientes, clientes[cantClientes].getIp(), 
